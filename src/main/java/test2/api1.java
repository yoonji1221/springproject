...
=======
    ...
    public static void main(String[] args) throws Exception {
      ...
      URL url = new URL(URL+"?ServiceKey="+KEY+"&numOfRows=100&pageNo=1&progrmBgnde=20200101&progrmEndde=20200505&_type=json");
...
>>>>>>> branch 'master' of https://github.com/yoonji1221/springproject.git
