...
//	      JSONArray personArray = (JSONArray) jsonObj.get("response/body");
			...
			System.out.println("봉사제목 : "+progrmCn);
			System.out.println("상세내용 : "+progrmSj);
			
			
			
			System.out.println("모집기관 : " + mnnstNm);
			System.out.println("등록기관 : " + nanmmbyNm);
			System.out.println("담당자명 : " + nanmmbyNmAdmn);
			System.out.println("담당자 주소 : " + postAdres);
			System.out.println("담당자 번호 : " + telno);
