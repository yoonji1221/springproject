...
<%
	...
	///////////////////////////////////
			...
			for(VinfoVO vo : list ) {
				//cid=vo.getCid();
				progrmRegistNo=vo.getProgrmRegistNo();
				progrmBgnde=Integer.parseInt(vo.getProgrmBgnde());
				rcritNmpr=vo.getRcritNmpr();
				appTotal=vo.getAppTotal();
				progrmSj=vo.getProgrmSj();
				
				
				rcritState=rcritNmpr-appTotal;
				if(rcritState==0){
					srcritState="모집완료";
				}
				else{
					...
					<TR>
						...
						<%
...

							{
								...
								if(iUseDate==progrmBgnde && srcritState.equals("모집완료")){
									//out.println(srcritState);
									backColor ="FAE0D4";
								}else if(iUseDate==progrmBgnde && srcritState.equals("모집중")){
									//out.println(srcritState);
									backColor ="#FFD9EC";
								}
...
//////////////////////////////////////////////////////////////////////
								...
								if(iUseDate==progrmBgnde){
									//out.println(cid);
									//out.println(progrmRegistNo);
									out.println("<div class=\"date_wrap\">");
								
									out.println("<label><em>"+srcritState+"</em></label>");
									
									out.println("</div>");
									out.println("<div>");
									out.println("<label><em><a href ="+"voldetail?progrmRegistNo="+progrmRegistNo+">"+progrmSj+"</a></em></label>");
									
									out.println("<BR>모집인원:"+appTotal+"/"+rcritNmpr+"명<BR>");
									out.println("</div>");
									}
