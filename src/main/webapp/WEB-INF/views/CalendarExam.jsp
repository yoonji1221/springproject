...
<BODY>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
		<tr>
		<td align="right"><input type="button" onclick="javascript:location.href='<c:url value='/volunteerMypage' />'" value="오늘" /></td>
		</tr>
	</table>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1" id="KOO" bgcolor="#F3F9D7" style="border: 1px solid #CED99C">
		...
		<td height="60">
			...
			<td align="center">
				...
				<!-- 이전해 -->
				</a> <%if(month > 0 ){ %> <a href="<c:url value='/volunteerMypage' />?year=<%=year%>&amp;month=<%=month-1%>" target="_self"> <b>&lt;</b>
				<!-- 이전달 -->
				</a> <%} else {%> <b>&lt;</b> <%} %> &nbsp;&nbsp; <%=year%>년 <%=month+1%>월 &nbsp;&nbsp; <%if(month < 11 ){ %> 
				<a href="<c:url value='/volunteerMypage' />?year=<%=year%>&amp;month=<%=month+1%>" target="_self"> 
				<!-- 다음달 -->
				<b>&gt;</b>
